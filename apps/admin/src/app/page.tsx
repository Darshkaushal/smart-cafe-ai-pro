...
export default function DashboardPage() {
  ...
  const stats = data ? [
    ...
    { label: "AI Chats", value: data.stats.conversations, icon: BotMessageSquare, tone: "text-purple-300" },
      ...
      <AdminShell>
        <div className="mb-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-white/50">Premium admin panel for orders, customers, bookings, chatbot conversations and ML predictions.</p>
          </div>
          <div className="admin-soft p-4 text-sm text-white/55">
            <p className="font-bold text-white">System status</p>
            <p className="mt-1">API + MySQL connected</p>
          </div>
        </div>
            ...
            <section className="mt-6 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
              <div className="admin-card">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-admin-gold">Machine learning</p>
                    <h2 className="mt-1 text-2xl font-black">Next ML Predictions</h2>
                  </div>
              ...
              <div className="admin-card bg-gradient-to-br from-admin-gold/15 to-white/[0.035]">
                ...
                <div className="mt-5 grid gap-3">
                  {[
                    ...
                    "Review AI chat demand to understand customer taste.",
                    "Prepare extra stock when prediction is above 75%.",
