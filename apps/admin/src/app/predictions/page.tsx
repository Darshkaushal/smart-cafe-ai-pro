...
export default function PredictionsPage() {
  ...
  return (
    <AuthGuard><AdminShell>
      <h1 className="mb-6 text-4xl font-black">Machine Learning Demand Predictor</h1>
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        {!items.length && <p className="text-white/60">No predictions yet. Run `python apps/ml/train_predict.py`.</p>}
      </div>
